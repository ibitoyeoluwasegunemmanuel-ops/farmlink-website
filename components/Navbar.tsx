        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          {isAuthenticated && (
            ...
            >
              ...
              <span className="absolute -top-0.5 -right-0.5 bg-red-500 text-white text-[10px] font-black w-4 h-4 rounded-full flex items-center justify-center leading-none">3</span>
            </Link>
          )}
          {/* Cart button */}
          <Link
